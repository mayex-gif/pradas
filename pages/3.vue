  ...
  <div>
    ...
    <v-hover v-slot="{ hover }" open-delay="50" close-delay="50">
      <v-card :elevation="hover ? 15 : 10" :class="{ 'on-hover':hover }" class="mx-auto mt-3" max-width="%90" tile>
        <v-list-item>
          <v-list-item-content>
            <h1 class="text-center">BIENES</h1>
          </v-list-item-content>
        </v-list-item>
        <v-list-item two-line>
          <v-list-item-content>
            ...
            <p><br>El término Bienes es el plural de la palabra bien; se refieren a cualquier cosa, tangible o intangible, que sea útil para el hombre y le satisfaga, directa o indirectamente, algún deseo o necesidad individual o colectiva, o que contribuya al bienestar de los individuos.
        ...
        <v-list-item>
          <v-list-item-content two-line>
            ...
            <v-divider class="mb-1"></v-divider>
            <p><br>Existen diferentes tipos de bienes, entre ellos:</p>
