      ...
      <v-card :elevation="hover ? 15 : 10" :class="{ 'on-hover':hover }" class="mx-auto mt-3" max-width="100%" tile>
        <v-list-item>
          ...
          <v-list-item-content>
            ...
            <center><br><br><img src="https://definicion.de/wp-content/uploads/2014/10/sujeto-de-derecho.jpg" width="40%"></center>
          </v-list-item-content>
        </v-list-item>
        ...
        <v-list-item three-line>
          <v-list-item-content>
            ...
            <img src="https://www.soyconta.com/wp-content/uploads/2019/09/tipos_sociedades_mercantiles.jpg" width="300px" height="300px">
          </v-list-item-content>
        </v-list-item>
